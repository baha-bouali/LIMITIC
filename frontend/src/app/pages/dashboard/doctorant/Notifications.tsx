...
type NotifType = 'PUB_SUBMITTED' | 'PUB_APPROVED' | 'PUB_REJECTED' | 'THESIS_UPDATE' | 'GENERAL';
...
const initialNotifs: Notification[] = [
  { id: '1', type: 'PUB_APPROVED', title: 'Publication approuvée !', message: '"Blockchain Security Analysis for Healthcare Data" a été approuvée par l\'administration. Elle est maintenant visible publiquement.', time: 'Il y a 1 heure', read: false },
  { id: '2', type: 'PUB_REJECTED', title: 'Publication rejetée', message: '"IoT Optimization for Medical Devices" a été rejetée. Motif : "Manque de données expérimentales. Veuillez enrichir la section résultats."', time: 'Hier à 11h00', read: false },
  { id: '3', type: 'THESIS_UPDATE', title: 'Rappel — Réunion avec votre directeur', message: 'Dr. Ahmed Ben Salem vous a programmé une réunion de suivi de thèse pour le 28 mai 2026 à 10h00.', time: 'Il y a 2 jours', read: false },
  { id: '4', type: 'PUB_SUBMITTED', title: 'Soumission enregistrée', message: '"Deep Learning for MRI Segmentation" a bien été soumise pour révision. Vous serez notifié dès qu\'une décision est prise.', time: 'Il y a 3 jours', read: true },
  { id: '5', type: 'GENERAL', title: 'Nouveau document disponible', message: 'Le formulaire de rapport d\'avancement pour l\'année académique 2025-2026 est disponible. Veuillez le compléter avant le 30 juin.', time: 'Il y a 4 jours', read: true },
  { id: '6', type: 'PUB_APPROVED', title: 'Félicitations !', message: '"Deep Learning for Medical Imaging" a été publiée avec succès. Quartile Q2. Partagez cette nouvelle !', time: 'Il y a 1 semaine', read: true },
];
...
const typeConfig: Record<NotifType, { icon: ComponentType<{ size?: number; className?: string }>; color: string; bgColor: string; label: string; variant: any }> = {
  PUB_SUBMITTED: { icon: FileText, color: 'text-accent-blue', bgColor: 'bg-accent-blue/10', label: 'Soumise', variant: 'info' },
  ...
  THESIS_UPDATE: { icon: BookOpen, color: 'text-warning', bgColor: 'bg-warning/10', label: 'Thèse', variant: 'warning' },
  GENERAL: { icon: Bell, color: 'text-text-muted', bgColor: 'bg-light-gray', label: 'Général', variant: 'default' },
};

export default function DoctorantNotifications() {
